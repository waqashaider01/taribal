    ...
    <div id="page" class="site">
                                                ...
                                                <ul class="mega-sub-menu">
                                                    <li class="row">
                                                        <ul class="col">
                                                            ...
                                                            <li class="current-menu-item"><a href="portfolio-metro-no-gap.html">Portfolio Metro No Space</a></li>
        ...
        <div id="content" class="site-content">
            <div class="page-header dtable text-center header-transparent pheader-portfolio">
                <div class="dcell">
                    <div class="container">
                        <h1 class="page-title">Portfolio Metro Space</h1>
                        <ul id="breadcrumbs" class="breadcrumbs none-style">
                            <li><a href="index.html">Home</a></li>
                            <li class="active">Portfolio Metro Space</li>
                        </ul>    
                    </div>
                </div>
            </div>
                                    ...
                                    <div class="projects-box">
                                        <div class="projects-thumbnail">
                                            <a href="portfolio-big.html">
                                                <img src="images/projects-grid/project-metro2.jpg" alt="">
                                            </a>
                                            <div class="overlay">
