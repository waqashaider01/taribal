                                                ...
                                                <ul class="mega-sub-menu">
                                                    <li class="row">
                                                        ...
                                                        <ul class="col">
                                                            ...
                                                            <li class="current-menu-item"><a href="portfolio-right.html">Right Images</a></li>
                                                    ...
                                                    <ul class="sub-menu">
                                                        ...
                                                        <li class="menu-item-has-children"><a href="#">Portfolio Hover Types</a>
                                                            <ul class="sub-menu">
                                                                ...
                                                                <li class="current-menu-item"><a href="portfolio-right.html">Right Image</a></li>
                                ...
                                <div id="gallery-2" class="gallery gallery-columns-1 s2">
                                    <figure class="gallery-item">
                                        <div class="gallery-icon portrait">
                                            <a href="images/p-gallery5-2.jpg">
                                                <img src="images/p-gallery5.jpg" alt="">
                                    ...
                                    <figure class="gallery-item">
                                        <div class="gallery-icon portrait">
                                            <a href="images/p-gallery6-2.jpg">
                                                <img src="images/p-gallery6.jpg" alt="">
                                                <span class="overlay"><i class="ot-flaticon-add"></i></span>
                                            </a>
                                        </div>
                                    </figure>
                                    <figure class="gallery-item">
                                        <div class="gallery-icon portrait">
                                            <a href="images/p-gallery7-2.jpg">
                                                <img src="images/p-gallery7.jpg" alt="">
                                                <span class="overlay"><i class="ot-flaticon-add"></i></span>
                                            </a>
                                        </div>
                                    </figure>
