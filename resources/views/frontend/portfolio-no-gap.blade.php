    ...
    <div id="page" class="site">
                                                ...
                                                <ul class="mega-sub-menu">
                                                    <li class="row">
                                                        <ul class="col">
                                                            ...
                                                            <li class="current-menu-item"><a href="portfolio-no-gap.html">Portfolio Grid No Gap</a></li>
        ...
        <div id="content" class="site-content">
            <div class="page-header dtable text-center header-transparent pheader-portfolio">
                <div class="dcell">
                    <div class="container">
                        <h1 class="page-title">Portfolio Grid No Gap</h1>
                        <ul id="breadcrumbs" class="breadcrumbs none-style">
                            <li><a href="index.html">Home</a></li>
                            <li class="active">Portfolio Grid No Gap</li>
                        </ul>    
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-lg-12 text-center theratio-align-center">
                        ...
                        <div class="project-filter-wrapper">
                            ...
                            <div class="projects-grid pf_3_cols style-2 img-scale no-gaps">
