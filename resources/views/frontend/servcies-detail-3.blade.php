...
@section('main-container')
    <div id="content" class="site-content">
        <div class="page-header dtable text-center header-transparent pheader-service-detail3">
            <div class="dcell">
                <div class="container">
                    <h1 class="page-title my-service-title my-custom-style" >"Space is the breath of art"<span style="font-size:25px;">- Frank Loloyd Wright</span>
                    </h1>
                    <ul id="breadcrumbs" class="breadcrumbs none-style">
                        <li><a href="index.html">Home</a></li>
                        <li><a href="our-services.html">Our Services</a></li>
                        <li class="active">Custom Solutions</li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                <!-- <div class="widget-area col-lg-3 col-md-12">
                        <div class="widget widget_nav_menu">
                            <ul class="services-menu">
                                <li class="current-menu-item"><a href="{{ url('/servcies-detail-3') }}"><span>01.</span> Design &
                                        Planning</a></li>
                ...
                <div class="widget-area col-lg-3 col-md-12">
                    <div class="widget widget_nav_menu">
                        <ul class="services-menu">
                            <li class="current-menu-item"><a><span>01</span> - DESIGN & PLANING
                                </a></li>
                            <li><a><span>02</span> - EXTERIOR DESIGN</a></li>
                            <li><a><span>03</span> - CUSTOM SOLUTIONS</a></li>
                            <li><a><span>04</span> - FURNITURE & DECOR</a></li>
                            <li><a><span>05</span> - CREATING CONCEPT</a></li>
                            <li><a><span>06</span> - AUTHOR'S CONTROL</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-9 col-md-12">
                    <div class="services-detail-content">
                        <div class="ot-heading ">
                            ...
                            <h2 class="main-heading">Interior
                                Decoration</h2>
                        </div>
                        ...
                        <div class="simple-slide owl-theme owl-carousel">
                            <div class="item"style="height:550px; width:435px; object-fit:cover; background-color:#9f9e9e">
                                <img src="images/idc1.jpeg" alt="" style="height:550px; width:435px; object-fit:cover;">
                            </div>
                            <div class="item"style="height:550px; width:435px; object-fit:cover; background-color:#9f9e9e">
                                <img src="" alt="">
                            </div>
                            <div class="item"style="height:550px; width:435px; object-fit:cover; background-color:#9f9e9e">
                                <img src="images/idc2.jpeg" alt="" style="height:550px; width:435px; object-fit:cover;">
                            </div>
                            <div class="item"style="height:550px; width:435px; object-fit:cover; background-color:#9f9e9e">
                                <img src="" alt="">
                            </div>
                        ...
                        <img src="images/idc3.jpeg" class="detail-img" width="100%" style="object-fit:cover;" alt="">
