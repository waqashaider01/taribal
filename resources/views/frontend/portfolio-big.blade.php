                                                ...
                                                <ul class="mega-sub-menu">
                                                    <li class="row">
                                                        ...
                                                        <ul class="col">
                                                            ...
                                                            <li class="current-menu-item"><a href="portfolio-big.html">Big Images</a></li>
                                                        </ul>
                                                        <ul class="col">
                                                    ...
                                                    <ul class="sub-menu">
                                                        ...
                                                        <li class="menu-item-has-children"><a href="#">Portfolio Hover Types</a>
                                                            <ul class="sub-menu">
                                                                ...
                                                                <li class="current-menu-item"><a href="portfolio-big.html">Big Image</a></li>
                                                            </ul>
                                                        </li>
                                ...
                                <div id="gallery-2" class="gallery gallery-columns-1 s2">
                                    <figure class="gallery-item">
                                        <div class="gallery-icon portrait">
                                            <a href="images/gallery-big-1.jpg">
                                    ...
                                    <figure class="gallery-item">
                                        <div class="gallery-icon portrait">
                                            <a href="images/gallery-big-2.jpg">
                                    ...
                                    <figure class="gallery-item">
                                        <div class="gallery-icon portrait">
                                            <a href="images/gallery-big-3.jpg">
                                    ...
                                    <figure class="gallery-item">
                                        <div class="gallery-icon portrait">
                                            <a href="images/gallery-big-4.jpg">
