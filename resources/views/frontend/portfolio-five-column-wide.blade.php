                                                ...
                                                <ul class="mega-sub-menu">
                                                    <li class="row">
                                                        ...
                                                        <ul class="col">
                                                            ...
                                                            <li class="current-menu-item"><a href="portfolio-five-column-wide.html">Five Columns Wide</a></li>
                                                        </ul>
                                                        <ul class="col">
                ...
                <div class="dcell">
                    <div class="container">
                        ...
                        <ul id="breadcrumbs" class="breadcrumbs none-style">
                            ...
                            <li class="active">Portfolio Grid 5 Columns</li>
                        </ul>    
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-lg-12 text-center theratio-align-center">
                        ...
                        <div class="project-filter-wrapper">
                            ...
                            <div class="projects-grid pf_5_cols style-1 img-scale w-auto mx-0">
                                ...
                                <div class="project-item category-14">
                                    <div class="projects-box">
                                        ...
                                        <div class="portfolio-info">
                                            <div class="portfolio-info-inner">
                                                <h5><a class="title-link" href="portfolio-left.html">Loft Kitchen Interior</a></h5>
                                                <p class="portfolio-cates"><a href="#">architecture</a></p> 
                                            </div>
                                            <a class="overlay" href="portfolio-left.html"></a>
                                        </div>
                                ...
                                <div class="project-item category-19">
                                    <div class="projects-box">
                                        ...
                                        <div class="portfolio-info">
                                            <div class="portfolio-info-inner">
                                                <h5><a class="title-link" href="portfolio-right.html">White Italian Villa</a></h5>
                                ...
                                <div class="project-item category-19">
                                    <div class="projects-box">
                                        <div class="projects-thumbnail">
                                            <a href="portfolio-big.html">
                                                <img src="images/projects-grid/project10.jpg" alt="">
                                            </a>
                                            <div class="overlay">
                                        ...
                                        <div class="portfolio-info">
                                            <div class="portfolio-info-inner">
                                                <h5><a class="title-link" href="portfolio-big.html">Minimalistic Art House</a></h5>
                                                <p class="portfolio-cates"><a href="#">architechture</a><a href="#">decor</a></p> 
                                            </div>
                                            <a class="overlay" href="portfolio-big.html"></a>
                                        </div>
                                    </div>
