...
<body>
    ...
    <div id="page" class="site">
                                        ...
                                        <ul class="menu">
                                            ...
                                            <li class="menu-item-has-children current-menu-item current-menu-ancestor"><a href="#">Pages</a>
                                                <ul class="sub-menu">
                                                    ...
                                                    <li class="current-menu-item"><a href="our-studio.html">Our Stufio</a></li>
                                            ...
                                            <ul id="menu-main-menu" class="mobile_mainmenu none-style">
                                                ...
                                                <li class="menu-item-has-children current-menu-item current-menu-ancestor"><a href="#">Pages</a>
                                                    <ul class="sub-menu">
                                                        ...
                                                        <li><a href="single-team.html">Single Team</a></li>
                                                        <li><a href="our-process.html">Our Process</a></li>
                                                        <li class="current-menu-item"><a href="our-studio.html">Our Studio</a></li>
                                                        <li class="menu-item-has-children"><a href="shop.html">Shop</a>
                                                            <ul class="sub-menu">
                                                                <li><a href="single-product.html">Single Product</a></li>
                                                                <li><a href="checkout-page.html">Checkout Page</a></li>
        ...
        <section class="our-studio pb-0">
            <div class="container">
                <div class="row">
                    <div class="col-xl-8 col-lg-12 col-md-12">
                        <div class="studio-img">
                            <img src="images/image1-studio.jpg" alt="">
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-12 col-md-12 pl-xl-7">
                        <div class="our-studio-detail">
                            ...
                            <p>Live minimalism is not about a ‘wrap’ or visual look. It refers to feeling.</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-12 align-self-center">
                        <div class="services-studio-img">
                            <img src="images/image2-studio.png" alt="">
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-12 align-self-center">
                        <div class="services-studio-detail">
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-6">
                                    <div class="icon-box icon-box--bg-img icon-box--icon-top mb-5 mb-md-0">
                                ...
                                <div class="col-lg-6 col-md-6">
                                    <div class="icon-box icon-box--bg-img icon-box--icon-top last mb-5 mb-md-0">
                ...
                <div class="row m-0">
                    ...
                    <div class="studio-testi-img text-center">
                        <div class="studio-testi-img-block">
                            <img src="images/image3-studio.jpg" alt="">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="clients-process pt-0">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="clients-slide owl-theme owl-carousel">
                            <div class="img-item">
                                <figure><img src="images/client01.svg" alt=""></figure>
                            </div>
                            <div class="img-item">
                                <figure><img src="images/client02.svg" alt=""></figure>
                            </div>
                            <div class="img-item">
                                <figure><img src="images/client03.svg" alt=""></figure>
                            </div>
                            <div class="img-item">
                                <figure><img src="images/client04.svg" alt=""></figure>
                            </div>
                            <div class="img-item">
                                <figure><img src="images/client05.svg" alt=""></figure>
                            </div>
                            <div class="img-item">
                                <figure><img src="images/client06.svg" alt=""></figure>
                            </div>
                            <div class="img-item">
                                <figure><img src="images/client01.svg" alt=""></figure>
                            </div>
        ...
        <section class="portfoli-studio">
            <div class="container-fluid">
                ...
                <div class="row projects-grid">
                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 mb-5 mb-xl-0">
                            ...
                            <div class="projects-box">
                                ...
                                <div class="portfolio-info">
                                    <div class="portfolio-info-inner">
                                        <h5><a class="title-link" href="portfolio-details-1.html">Stylish Family Appartment</a></h5>
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 mb-5 mb-xl-0">
                        <div class="project-items">
                            <div class="projects-box">
                                ...
                                <div class="portfolio-info">
                                    <div class="portfolio-info-inner">
                                        <h5><a class="title-link" href="portfolio-details-2.html">Minimal Guests House</a></h5>
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 mb-5 mb-md-0">
                        <div class="project-items">
                            <div class="projects-box">
                                <div class="projects-thumbnail">
                                ...
                                <div class="portfolio-info">
                                    <div class="portfolio-info-inner">
                                        <h5><a class="title-link" href="portfolio-details-3.html">Art Family Residence</a></h5>
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
                        <div class="project-items">
                            <div class="projects-box">
                                ...
                                <div class="portfolio-info">
                                    <div class="portfolio-info-inner">
                                        <h5><a class="title-link" href="portfolio-details-4.html">Private House in Spain</a></h5>
                                        <p class="portfolio-cates"><a href="#">Furniture</a></p> 
                                    </div>
                                    <a class="overlay" href="portfolio-details-4.html"></a>
                                </div>
                            </div>
                        </div>
                    </div>
