                                                ...
                                                <ul class="mega-sub-menu">
                                                    <li class="row">
                                                        ...
                                                        <ul class="col">
                                                            ...
                                                            <li class="current-menu-item"><a href="hidden-1.html">Hidden 1</a></li>
                ...
                <div class="row">
                    <div class="col-lg-12 text-center theratio-align-center">
                        ...
                        <div class="project-filter-wrapper">
                            ...
                            <div class="projects-grid pf_4_cols style-4 img-popup img-scale w-auto mx-0">
                                <div class="grid-sizer"></div>
                                <div class="project-item category-19 ">
                                    <div class="projects-box">
                                        <div class="projects-thumbnail" data-src="images/projects-grid/project-metro1.jpg">
                                ...
                                <div class="project-item category-14 ">
                                    <div class="projects-box">
                                        <div class="projects-thumbnail" data-src="images/projects-grid/project-metro2.jpg">
